...
from tensorflow.keras.layers import Input, Dense, Dropout, Flatten,GlobalAveragePooling2D, Conv2D, Activation, BatchNormalization, MaxPooling2D
...
# final_model.save('2_8_affectnet_adddata.h5')
